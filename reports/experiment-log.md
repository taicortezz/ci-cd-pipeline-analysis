...
| 8 | CI | #8 | 4af8797 | Adiciona falha controlada para experimento CI | main | push | Failure | 18s | lint = 12s; tests = 14s | 49 | 1 | test-results | 1.33 KB | Introducao de falha controlada em um teste automatizado. | O job de lint permaneceu verde enquanto o job de testes falhou. A execucao demonstra o comportamento do pipeline diante de falhas reais e confirma que os artefatos continuam sendo gerados mesmo quando os testes falham. |
| 9 | CI | #9 | 0033da0 | Remove falha controlada do CI | main | push | Success | 20s | lint = 11s; tests = 17s | 48 | 0 | test-results | 1.15 KB | Recuperacao da pipeline apos falha controlada. | Apos remover o teste que falhava intencionalmente, o pipeline voltou ao estado saudavel. Esta execucao permite comparar diretamente o comportamento antes e depois da falha. |
